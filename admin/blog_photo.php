...
<?php if( $record['photo'] ): ?>
  ...
  <p><a href="blog_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
...
<p><a href="blog.php"><i class="fas fa-arrow-circle-left"></i> Return to Article List</a></p>
