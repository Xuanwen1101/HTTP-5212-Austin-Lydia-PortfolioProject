...
<?php if ($record['photo']) : ?>
  ...
  <div class="objects-container">
    <img src="data:image/jpg;base64,<?php echo base64_encode($data); ?>" width="200" height="200" alt="Current Skill Icon">
  </div>
  <div class="delete-photo">
    <a href="skills_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a>
  </div>
