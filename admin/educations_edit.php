...
<form method="post">
  ...
  <input type="text" name="school_url" id="school_url" value="<?php echo htmlentities( $record['school_url'] ); ?>">
  ...
  <input type="text" name="major_url" id="major_url" value="<?php echo htmlentities( $record['major_url'] ); ?>">
